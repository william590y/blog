...
I have found this idea of overfitting very useful when thinking about situations where people place too much attention on specifics at the expense of the big picture, missing the forest for the trees. A friend pointed out to me that when people attempt to mimic the habits billionaires by suddenly journaling, reading self-help, and [putting butter in their coffee](https://en.wikipedia.org/wiki/Dave_Asprey), that this can be interperted as a kind of overfitting. A lot of conspiratorial thinking, where people connect the dots to see a pattern that isn't there, also seems to me to also be a case of overfitting.
