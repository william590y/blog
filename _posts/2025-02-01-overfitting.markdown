...
In the social sciences, phenomena tend to be far more stochastic and multifactorial compared to the natural sciences. This has lead many in the "soft sciences" to try to [emulate their "harder science" counterparts](https://en.wikipedia.org/wiki/Physics_envy). One major difference in these fields is that compared to a discipline like physics, where something very close to a rigorous mathematical understanding of  every facet of a phenomenon is possible, sociology can only provide qualitative descriptions of small parts of a bigger picture.
