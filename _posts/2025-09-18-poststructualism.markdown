...
If one is instead making a claim about consciousness, I tend to agree with the conservative view that these systems [lack the ability to feel](https://plato.stanford.edu/entries/qualia/). But I think we should resist the temptation to claim that human cognition is so special when [benchmarks are being crushed](https://agi.safe.ai/) faster than they are being produced. Perhaps our minds aren't so different from their silicon-based counterparts after all, and by studying them we can learn more about our own nature.